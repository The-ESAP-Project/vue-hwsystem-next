<template>
  ...
  >
    <div class="max-w-4xl mx-auto">
      ...
      <!-- 作业详情卡片 -->
      <div
        class="bg-white dark:bg-gray-800 rounded-3xl shadow-lg border border-gray-200/50 dark:border-gray-700/50 p-6 sm:p-8 mb-6"
      >
          ...
          <div class="flex-1">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 text-sm">
              ...
              <div class="flex items-center gap-2 text-gray-600 dark:text-gray-400">
                ...
                <span
                  >提交次数: {{ assignment.attempts }}/{{
                    assignment.maxAttempts || '无限制'
                  }}</span
                >
              </div>
              <div class="flex items-center gap-2 text-gray-600 dark:text-gray-400">
      ...
      <!-- 提交区域 -->
      <div
        class="bg-white dark:bg-gray-800 rounded-3xl shadow-lg border border-gray-200/50 dark:border-gray-700/50 p-6 sm:p-8"
      >
        ...
        <form @submit.prevent="submitAssignment" class="space-y-6">
          ...
          <div>
            ...
            <div
              class="border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-2xl p-6 text-center hover:border-indigo-500 dark:hover:border-indigo-400 transition-colors duration-200"
            >
              <svg
      ...
      <div
        ...
        class="mt-6 bg-white dark:bg-gray-800 rounded-3xl shadow-lg border border-gray-200/50 dark:border-gray-700/50 p-6 sm:p-8"
      >
