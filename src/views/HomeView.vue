<template>
  <div class="bg-white dark:bg-gray-900 transition-colors duration-200">
    ...
    <div class="relative isolate px-6 pt-20 lg:px-8">
      ...
      <div class="mx-auto max-w-2xl py-16 sm:py-24 lg:py-32">
        <div class="hidden sm:mb-8 sm:flex sm:justify-center">
          <div
            class="relative rounded-full px-3 py-1 text-sm/6 text-gray-600 dark:text-gray-300 ring-1 ring-gray-900/10 dark:ring-gray-700/50 hover:ring-gray-900/20 dark:hover:ring-gray-700 transition-colors duration-200"
          >
            {{ t('home.hero.badge') }}
        ...
        <div class="text-center">
          <h1
            class="text-balance text-5xl font-semibold tracking-tight text-gray-900 dark:text-white sm:text-7xl transition-colors duration-200"
          >
            {{ t('home.hero.title') }}
          </h1>
          <p
            class="mt-8 text-pretty text-lg font-medium text-gray-500 dark:text-gray-400 sm:text-xl/8 transition-colors duration-200"
          >
          ...
          <div class="mt-10 flex items-center justify-center gap-x-6">
            ...
            <a
              href="#roles"
              class="text-sm/6 font-semibold text-gray-900 dark:text-white transition-colors duration-200"
            >
        ...
        <div class="mx-auto mt-16 max-w-2xl sm:mt-20 lg:mt-24 lg:max-w-4xl">
          ...
          >
            <div v-for="feature in features" :key="feature.name" class="relative pl-16">
              <dt
                class="text-base/7 font-semibold text-gray-900 dark:text-white transition-colors duration-200"
              >
                <div
                  class="absolute left-0 top-0 flex size-10 items-center justify-center rounded-lg bg-indigo-600 dark:bg-indigo-500"
                >
              ...
              <dd
                class="mt-2 text-base/7 text-gray-600 dark:text-gray-300 transition-colors duration-200"
              >
                {{ feature.description }}
              </dd>
            </div>
    ...
    <div
      id="roles"
      class="bg-gray-50 dark:bg-gray-800 py-24 sm:py-32 transition-colors duration-200"
    >
      <div class="mx-auto max-w-7xl px-6 lg:px-8">
        <div class="mx-auto max-w-2xl text-center">
          ...
          <p
            class="mt-2 text-balance text-4xl font-semibold tracking-tight text-gray-900 dark:text-white sm:text-5xl transition-colors duration-200"
          >
        ...
        <div
          class="mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:mt-20 lg:mx-0 lg:max-w-none lg:grid-cols-3"
        >
          <div
            v-for="role in roles"
            :key="role.name"
            class="flex h-full flex-col items-start justify-between bg-white dark:bg-gray-700 p-8 rounded-2xl shadow-sm ring-1 ring-gray-200 dark:ring-gray-600 transition-colors duration-200"
          >
            <div class="flex-1 w-full">
              <div class="flex items-center gap-x-4">
                <div
                  class="flex size-12 items-center justify-center rounded-lg bg-indigo-50 dark:bg-indigo-900/50"
                >
                  <component
                    :is="role.icon"
                ...
                <h3
                  class="text-lg/6 font-semibold text-gray-900 dark:text-white transition-colors duration-200"
                >
                  {{ role.name }}
                </h3>
              </div>
              <p
                class="mt-4 text-sm/6 text-gray-600 dark:text-gray-300 transition-colors duration-200"
              >
                {{ role.description }}
              </p>
              <div class="mt-6">
                <ul class="space-y-2">
                  <li
                    ...
                    :key="feature"
                    class="flex items-center text-sm text-gray-600 dark:text-gray-300 transition-colors duration-200"
                  >
                    <CheckIcon
                      class="mr-2 size-4 text-green-500 dark:text-green-400 flex-shrink-0"
                      aria-hidden="true"
                    />
                    {{ feature }}
                  </li>
